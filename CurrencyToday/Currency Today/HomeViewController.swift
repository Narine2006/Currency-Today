...
class HomeViewController: UIViewController {
    ...
    func configure(){
        models.append(contentsOf: [
            ...
            CourseOption(name: "USD", currency: "USA", backgroundimage: UIImage(named: "use")!, backgroundcolor: .white, course: "1"),
            CourseOption(name: "EUR", currency: "Europe", backgroundimage: UIImage(named: "eu")!, backgroundcolor: .white, course: "1"),
            CourseOption(name: "RUB", currency: "Russia", backgroundimage: UIImage(named: "ru")!, backgroundcolor: .white, course: "1"),
            CourseOption(name: "CNY", currency: "China", backgroundimage: UIImage(named: "cin")!, backgroundcolor: .white, course: "1"),
            CourseOption(name: "INR", currency: "India", backgroundimage: UIImage(named: "in")!, backgroundcolor: .white, course: "1"),
            CourseOption(name: "CAD", currency: "Canada", backgroundimage: UIImage(named: "ka")!, backgroundcolor: .white, course: "1"),
            CourseOption(name: "TRY", currency: "Turkey", backgroundimage: UIImage(named: "tu")!, backgroundcolor: .white, course: "1"),
            CourseOption(name: "GEL", currency: "Georgia", backgroundimage: UIImage(named: "go")!, backgroundcolor: .white, course: "1"),
            CourseOption(name: "KRW", currency: "South Korea", backgroundimage: UIImage(named: "Kor")!, backgroundcolor: .white, course: "1"),
            CourseOption(name: "BRL", currency: "Brazil", backgroundimage: UIImage(named: "Br")!, backgroundcolor: .white, course: "1"),
            CourseOption(name: "JOD", currency: "Jordan", backgroundimage: UIImage(named: "jor")!, backgroundcolor: .white, course: "1")
        ])
    }
